...
class EntityAutocompleteMatcher {
  ...
  public function getMatches($target_type, $selection_handler, array $selection_settings, $string = '', $page = 0) {
    ...
    if (isset($string)) {
      ...
      $match_limit = !empty($selection_settings['match_limit']) ? $selection_settings['match_limit'] : 10;
      $entity_labels = $handler->getReferenceableEntities($string, $match_operator, $match_limit, $page * $match_limit);
